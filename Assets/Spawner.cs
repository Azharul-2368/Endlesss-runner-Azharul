...
public class Spawner : MonoBehaviour
{
    ...
    public float minSpawnTime = 0.0f;  //Minimum amount of time between spawning objects 
    ...
    void Update()
    {
        //Add Time.deltaline returns the amount of time passed since the last frame.
        ...
        {
            //Use Random.Range to pick a number between 0 and the amount of items we have on our subject list
            ...
            //After spawning we select a new random time for the nex spawn and set our timer back to zero
            timeToNextSpawn = Random.Range(minSpawnTime, maxSpawnTime);
